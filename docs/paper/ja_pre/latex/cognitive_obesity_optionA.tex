...
この逆説をめぐり、2つの陣営が対立している。一方の規制派（Haidt, 2024; Twenge, 2017）はスマートフォンとSNSへの曝露制限を主張する。他方のデジタルリテラシー派はメディアリテラシー教育を処方する。しかし約10年にわたる論争は収束の兆しを見せない。メタ分析が積み重なるほどに、効果量は小さくなり、結論は混沌とする。なぜか。
